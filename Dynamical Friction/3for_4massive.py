...
l ,b ,r = 218 , 53.5 , 28.6
x ,y ,z = -15.299570, 5.111088, 15.693028
vx ,vy , vz = 152.472726, 166.385066, -105.386191
...
for i in range(1,7763):
	a = acceration(point)
	fake_point = copy.copy(point)
	fake_point.probe_advance(a[0],a[1],a[2], 0.0005085429256646,mass[i])
	a = acceration(fake_point)
	point.advance(a[0],a[1],a[2], 0.0005085429256646,mass[i])
	X.append(point.x)
	Y.append(point.y) 
	Z.append(point.z)
