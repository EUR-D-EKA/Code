...
def acceleration(point):
	#return list that contain acceleration in each axis
...
f2 = open('center_fileWithDF_10^10','w')
...
l ,b ,r = 218 , 53.5 , 28.6
x ,y ,z = -15.455143349587864, 5.030346113494129, 15.737778431521125
vx ,vy , vz =   151.89083652487335 ,166.6533151561379, -104.63948627830511 
