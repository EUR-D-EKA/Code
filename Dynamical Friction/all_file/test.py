...
f = open("center_fileWithDF_10^10")
f2 = open("center_fileWithoutDF_10^10")
f3 = open("dynamical_friction_10^10")
distance = []
time_step = []
DF = []
i = 0
...
plt.title('Difference between With and withou DF(3.95Gyr with mass of 60000)')
plt.xlabel('time_step')
plt.ylabel('Difference(kpc)')

plt.figure()
plt.plot(time_step,DF)
plt.title('magnitude of DF(3.95Gyr with mass of 60000)')
plt.xlabel('time_step')
